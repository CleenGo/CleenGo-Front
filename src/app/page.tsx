...
export default function LandingPage() {
  return (
    <>
      {/* Rescata el access_token del hash y redirige a /oauth/callback */}
      <OAuthHashRedirect />

      {/* Contexto de autenticación para toda la landing */}
      <AuthProvider>
        {/* Hero Section */}
              ...
              <div className="space-y-8">
                ...
                <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30">
                  ...
                  <span className="text-sm font-medium">
                    La mejor plataforma de limpieza en Latinoamérica
                  </span>
                </div>
        ...
        <div className="bg-linear-to-br from-[#0A65FF] via-[#1E73FF] to-[#2CC9C9] py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-10 leading-relaxed">
              ...
              <br />y obtén un descuento especial!
            </p>
